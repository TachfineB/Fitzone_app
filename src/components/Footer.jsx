...
import { footerLinks, socialMedia } from "../constants/index3"
    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start m-10">
          <img src={logo} alt="fitzone" className="w-[200px] h-[200px] " />
          <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>Unleashing fitness potential, one member at a time.</p>
        ...
        <div className="flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10"> 
          {footerLinks.map((footerLink)=>(
            <div key={footerLink.key} className="flex flex-col ss:my-0 my-4 min-w-[150px]">
              <h4 className="font-poppins font-medium text-[18px] leading-[27px] text-white mt-12">
                {footerLink.title}
              </h4>
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 boder-t-[1px] border-t-[#3f3r45]">
        <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white mt-12">
        2023 FitZone. All Rights Reserved.
        </p>
